  ...
  return (
    <div className="w-full max-w-md mx-auto px-6 py-8 lg:py-12">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-white/70">Cadastre-se com uma conta</p>
        {error && (
        ...
        {success && (
          <div className="mt-3 text-green-400 text-sm bg-green-500/10 border border-green-500/20 rounded-lg p-3">
            {success}
          </div>
        )}
      </div>
